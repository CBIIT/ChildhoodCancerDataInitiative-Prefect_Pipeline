...
from src.utils import get_time, folder_dl, file_dl, file_ul
...
def submission_cruncher(bucket: str, submission_folder_path: str, template_path: str, runner: str) -> None:
    runner_logger = get_run_logger()

    # dl submission_folder_path
    runner_logger.info(f"Downloading folder {submission_folder_path} from bucket {bucket}")
