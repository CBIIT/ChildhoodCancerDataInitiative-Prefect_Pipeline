...
def run_template_exampler(
    ...
    Args:
        ...
        ccdi_manifest_version (str, optional): The tag name of CCDI-DCC manifest. Defaults to "default_to_latest".
    """    
    # create run logger
    ...
    if ccdi_manifest_version != "default_to_latest":
        ...
        if not check_tag:
            ...
            runner_logger.error(
                f"Version {ccdi_manifest_version} is not found among any ccdi-dcc-model releases. Here is a list of available tags you can use {*available_tags,}"
            )
            return None
        else:
