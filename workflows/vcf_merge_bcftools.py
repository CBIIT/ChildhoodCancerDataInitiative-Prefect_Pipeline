...
def download_handler(df: pd.DataFrame):
    ...
    for index, row in df.iterrows():
        ...
        if not os.path.isfile(f_name):
            ...
            process = subprocess.Popen(["gunzip", f_name,], shell=False, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE,)
            ...
            process = subprocess.Popen(["./bcftools", "sort", "-o", f_name.replace(".gz", ""), "-O", "z", f_name], shell=False, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE,)
