...
@flow(name="CCDI_to_SRA_submission", flow_run_name="CCDI_to_SRA_submission_{date}")
def CCDI_to_SRA(manifest: str, template: str, date: str, pre_submission=None,) -> tuple:
