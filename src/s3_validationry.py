...
def ValidationRy(file_path: str, template_path: str):  # removed profile
    ...
    with open(f"{file_dir_path}/{validation_out_file}", "w") as outf:
        ...
        #THESE TWO WHOLE SECTIONS HAVE BEEN COMMENTED OUT AS THEY REFER TO SRA AND IT'S CHECKS AND NOT THE ACTUAL
        #REQUIREMENTS OF THE VALIDATION OF THE TEMPALTE. THESE CHECKS ARE NOW HANDLES IN THE CCDI_TO_SRA SCRIPT.
